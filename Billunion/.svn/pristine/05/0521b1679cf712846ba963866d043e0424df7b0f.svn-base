...
+ (void)removeObserverWithScrollView:(UIScrollView*)scrollView head:(YYRrefreshControl*)header footer:(YYRefreshFooterView*)footer{
    [scrollView removeObserver:header forKeyPath:@"contentOffset"];
}
