...
//交易状态  0待交易  1交易中  2交易完成
@property (nonatomic,strong) NSNumber *TradeStatus;
@property (nonatomic,strong) NSNumber *TradeState;
...
//是否提供发票合同 && 是否需要发票合同  // 是 否
@property (nonatomic ,strong) NSNumber *NeedOrCanReceipt;
//@"目标客户"; // 全部 本行客户
@property (nonatomic ,strong) NSNumber *TargetCustomer;
