...
- (void)loadBuyerMarketDatas{
    ...
    if (self.BillType) {
        if ([self.BillType intValue] == 1) {
            keyArray  =@[@"Amount",@"DiscountRate",@"Change",@"BillType",@"AcceptorIdentityType",@"DueTimeRange",@"OfferName",@"Address",@"TradeTime",@"NeedOrCanReceipt",@"TargetCustomer"];
        }else{
            keyArray =@[@"Amount",@"DiscountRate",@"Change",@"BillType",@"AcceptorIdentityType",@"DueTimeRange",@"OfferName",@"TradeTime",@"NeedOrCanReceipt",@"TargetCustomer"];
        }
    }
    [self setDataInKeyValues:keyArray];
}
...
- (void)loadTradeRecords:(StockAllType)stockType{
    NSArray *keyArray;
        ...
        if (self.BillType && stockType == StockAllType_TradingRecord_Seller_Market ) {
            if ([self.BillType intValue] == 1) {
                keyArray =@[@"Amount",@"DiscountRate",@"BillType",@"Acceptor",@"DueTimeRange",@"CounterPartyName",@"TradeResult",@"Address",@"TradeRole",@"NeedOrCanReceipt"];
            }else{
                keyArray =@[@"Amount",@"DiscountRate",@"BillType",@"Acceptor",@"DueTimeRange",@"CounterPartyName",@"TradeResult",@"TradeRole",@"NeedOrCanReceipt"];
            }
        }
    
        if (self.BillType && stockType == StockAllType_TradingRecord_Buyer_Market ) {
            if ([self.BillType intValue] == 1) {
                keyArray =@[@"Amount",@"DiscountRate",@"BillType",@"Acceptor",@"DueTimeRange",@"CounterPartyName",@"TradeResult",@"Address",@"TradeRole",@"NeedOrCanReceipt",@"TargetCustomer"];
            }else{
                keyArray =@[@"Amount",@"DiscountRate",@"BillType",@"Acceptor",@"DueTimeRange",@"CounterPartyName",@"TradeResult",@"TradeRole",@"NeedOrCanReceipt",@"TargetCustomer"];
            }
        }
...
-(NSString *)getTradeRole:(NSNumber*)tradeRole{
    ...
    if (tradeRole.integerValue > 0 && tradeRole.integerValue <= arr.count) {
