...
- (void)didSelectCounterParty:(id)selectObject{
      AskBuyTableView *askBuyView = (AskBuyTableView *)[self getCurrentStockView];
    ...
    if ([selectObject isKindOfClass:[NSString class]]) {
        ...
        [_tradeViewModel setCurrentCounterPartyModel:selectObject];
    }
      askBuyView.counterPartyName = counterParty;
      askBuyView.counterPartyId = [_tradeViewModel getCurrentCounterPartyId];
}
